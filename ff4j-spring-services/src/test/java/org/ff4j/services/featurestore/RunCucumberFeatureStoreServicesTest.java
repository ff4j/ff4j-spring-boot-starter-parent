...
@CucumberOptions(features = "classpath:features/FeatureStoreServices.feature",
    plugin = {"json:target/cucumber/FeatureStoreServices.json",
        "junit:target/cucumber/FeatureStoreServices.xml"},
