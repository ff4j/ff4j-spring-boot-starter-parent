...
public class FeatureServicesStepDef extends AbstractStepDef {
  ...
  public void the_feature_with_and_exists_in_the_feature_store(String uid, String enabled,
      String description, String group, String csvPermissions) throws Throwable {
  ...
  public void the_user_requests_to_create_or_update_a_feature_with_feature_id_as_and_feature_spec_as(
      String featureUID, String featureSpec) throws Throwable {
  ...
  public void the_user_requests_to_grant_role_to_a_feature_with_feature_id_as(String roleName,
      String featureUID) throws Throwable {
    try {
  ...
  public void the_user_requests_to_remove_role_to_a_feature_with_feature_id_as(String roleName,
      String featureUID) throws Throwable {
    try {
  ...
  public void the_user_requests_to_add_group_to_a_feature_with_feature_id_as(String groupName,
      String featureUID) throws Throwable {
    try {
  ...
  public void the_user_requests_to_remove_group_to_a_feature_with_feature_id_as(String groupName,
      String featureUID) throws Throwable {
    try {
  ...
  public void the_user_gets_the_response_as_and(String expectedUid, String expectedEnabled,
      String expectedDescription, String expectedGroup, String expectedPermissions)
      throws Throwable {
    Feature expectedFeature = new Feature(expectedUid, Boolean.valueOf(expectedEnabled),
        expectedDescription, expectedGroup, Arrays.asList(expectedPermissions.split(",")));
