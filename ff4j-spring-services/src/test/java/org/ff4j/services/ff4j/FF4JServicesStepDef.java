...
public class FF4JServicesStepDef extends AbstractStepDef {
  ...
  public void the_feature_store_is_cached() throws Throwable {
    FF4jCacheProxy proxy = new FF4jCacheProxy(ff4j.getFeatureStore(), null,
  ...
  public void the_feature_store_has_the_following_security_information(
      List<TestAuthorizationsManager> authorizationsManagers) throws Throwable {
  ...
  public void the_user_requests_to_check_if_the_feature_is_flipped_with_feature_uid_as(
  ...
  private class TestAuthorizationsManager extends AbstractAuthorizationManager {
    ...
    public Set<String> getCurrentUserPermissions() {
      return StringUtils.isBlank(currentUserPermissions) ? null
          : new HashSet<String>(Arrays.asList(currentUserPermissions.split(",")));
    }

    @Override
    public Set<String> listAllPermissions() {
      return StringUtils.isBlank(allPermissions) ? null
          : new HashSet<String>(Arrays.asList(allPermissions.split(",")));
    }
  }
}
