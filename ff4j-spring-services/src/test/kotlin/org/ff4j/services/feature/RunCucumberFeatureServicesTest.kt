...
@SelectClasspathResource("features/FeatureServices.feature")
@ConfigurationParameters(
  ConfigurationParameter(
    key = Constants.GLUE_PROPERTY_NAME,
    value = "org.ff4j.services.feature"
  ),
  ConfigurationParameter(key = Constants.FILTER_TAGS_PROPERTY_NAME, value = "@FeatureServices"),
  ConfigurationParameter(
  ...
  ConfigurationParameter(
    ...
    value = "json:target/cucumber/FeatureServices.json"
  )
)
class RunCucumberFeatureServicesTest
