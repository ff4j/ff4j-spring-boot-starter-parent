...
@SelectClasspathResource("features/PropertyStoreServices.feature")
@ConfigurationParameters(
  ConfigurationParameter(
    key = Constants.GLUE_PROPERTY_NAME,
    value = "org.ff4j.services.propertystore"
  ),
  ConfigurationParameter(
    key = Constants.FILTER_TAGS_PROPERTY_NAME,
    value = "@PropertyStoreServices"
  ),
  ConfigurationParameter(
  ...
  ConfigurationParameter(
    ...
    value = "json:target/cucumber/PropertyStoreServices.json"
  )
)
class RunCucumberPropertyStoreServicesTest
