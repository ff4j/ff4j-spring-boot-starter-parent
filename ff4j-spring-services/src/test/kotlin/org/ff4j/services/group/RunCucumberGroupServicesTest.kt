...
@SelectClasspathResource("features/GroupServices.feature")
@ConfigurationParameters(
  ConfigurationParameter(
    key = Constants.GLUE_PROPERTY_NAME,
    value = "org.ff4j.services.group"
  ),
  ConfigurationParameter(key = Constants.FILTER_TAGS_PROPERTY_NAME, value = "@GroupServices"),
  ConfigurationParameter(
  ...
  ConfigurationParameter(
    ...
    value = "json:target/cucumber/GroupServices.json"
  )
)
class RunCucumberGroupServicesTest
