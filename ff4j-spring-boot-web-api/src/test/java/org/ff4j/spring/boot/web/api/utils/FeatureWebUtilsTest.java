...
public class FeatureWebUtilsTest {
    ...
    public void giveTheActionIsCreateWhenAskedForHttpStatusShouldReturn201_CREATED() {
        ResponseEntity<Boolean> actualResponse = FeatureWebUtils.INSTANCE.getBooleanResponseEntityByHttpStatus(FeatureActions.CREATED);
    ...
    public void giveTheActionIsUpdateWhenAskedForHttpStatusShouldReturn202_ACCEPTED() {
        ResponseEntity<Boolean> actualResponse = FeatureWebUtils.INSTANCE.getBooleanResponseEntityByHttpStatus(FeatureActions.UPDATED);
